 ...
 * under the License.
 */
package com.tinybox.base.util.csv.json2csv.parser;
...
public class JSONFlattener {
     ...
     * The class Logger
     */
    private static final Logger LOGGER = Logger.getLogger(JSONFlattener.class.getSimpleName());
...
//        } catch (IOException e) {
//            error("JsonFlattener#ParseJson(uri, encoding) IOException: ", e);
//        } catch (Exception ex) {
//            error("JsonFlattener#ParseJson(uri, encoding) Exception: ", ex);
//        }
//
//        return flatJson;
//    }
    ...
    public static List<Map<String, String>> parseJson(File file, String encoding) {
        ...
        try {
            json = FileIOUtils.readFile2String(file, encoding);
            flatJson = parseJson(json);
        } catch (Exception ex) {
            error("JsonFlattener#ParseJson(file, encoding) Exception: ", ex);
        }
    ...
    private static List<Map<String, String>> handleAsArray(String json) {
        ...
        try {
            ...
            error("JSON might be malformed, Please verify that your JSON is valid");
        }
